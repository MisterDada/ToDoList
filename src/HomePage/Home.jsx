    ...
    <>
      <div className={styles["body"]}>
        <aside className={styles["sidebar"]}>
          <div>
            ...
            <div className={styles["sidebar-img"]}>
              ...
              <Link className={styles["sidebar-link"]} to="Completed-Notes">
                Completed Notes
              </Link>
            </div>
          </div>
        ...
        <div className={styles["taskcontainer"]}>
          ...
          />
          <input
            className={styles["taskinput-description"]}
            type="text"
            ...
            {todos.map((task, index) => (
              <div key={index} className={styles["task"]}>
                ...
                <img
                  ...
                  src="src\assets\delete_24dp_1B3C3C_FILL0_wght400_GRAD0_opsz24.svg"
                  alt=""
                />
                <img
                  className={styles["task-button"]}
                  onClick={() => populateEditFields(index)}
                  src="src\assets\edit_square_24dp_1B3C3C_FILL0_wght400_GRAD0_opsz24.svg"
                  alt=""
                />
                <img
                  className={styles["task-button"]}
                  onClick={() => addToCompleteTodoPage(todos[index].name)}
                  src="src\assets\check_24dp_1B3C3C_FILL0_wght400_GRAD0_opsz24.svg"
                  alt=""
                />
              </div>
            ))}
